...
data_files.append(('share/' + package_name, [
    ...
    'launch/robot_launch_2.py',
    'launch/robot_launch_7.py',
...
data_files.append(('share/' + package_name + '/worlds', [
    ...
    'worlds/epuck_world_task.wbt',
    'worlds/epuck_world_2.wbt',
...
data_files.append(('share/' + package_name + '/resource', [
    ...
    'resource/map_task.pgm',
    'resource/map_task.yaml'
]))
data_files.append(('share/' + package_name, [
    'package.xml'
]))
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'vel = webots_ros2_epuck.publisher_vel:main',
            'driver = webots_ros2_epuck.driver:main',
            'driver_2 = webots_ros2_epuck.driver_2:main',
            'driver_3 = webots_ros2_epuck.driver_3:main',
            'driver_4 = webots_ros2_epuck.driver_4:main',
            'driver_5 = webots_ros2_epuck.driver_5:main',
            'driver_6 = webots_ros2_epuck.driver_6:main',
            'driver_7 = webots_ros2_epuck.driver_7:main',
